...
class HomeTests(TestCase):
    ...
    def test_home_view_contains_link_to_topics_page(self):
        board_topic_url = reverse('board_topics', kwargs={
                                  'pk': self.board.pk})
        self.assertContains(
...
class BoardTopicTest(TestCase):
    def setUp(self):
        Board.objects.create(name='Flask', description='Flask description')
...
class NewTopicTest(TestCase):
    def setUp(self):
        Board.objects.create(name="Flask", description="Flask Tutorial")
        User.objects.create(
            username='Olamide',
            email="olamidejubril68@gmail.com",
            password="password"
        )
